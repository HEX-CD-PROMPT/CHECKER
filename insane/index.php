...
$botToken = "6154761459:AAEecIAdtQSEhflVT62j961_j3H4kS9FDSw";
...
$emojid = '❌';
$emojil = '✅';
$owner = '<code>@INS4NE_XD</code>';
$botu = "𝐁𝐨𝐭 𝐔𝐩𝐝𝐚𝐭𝐞𝐬 ↯ @INS4NE_XD";
$cofuid = '1212';
$cofuid2 = '1212';
$cofuid3 = '1212';
#FIN DE LA CAPTURA
...
if ($cdata2 == "back") {
    ...
    $videoUrl = "https://t.me/okdiiecc/2";
...
if ($cdata2 == "price") {
  ...
  ";
    ...
    $priceKeyboard = json_encode([
        'inline_keyboard' => [
            [['text' => ' 𝙃𝙤𝙢𝙚 🏡 ', 'callback_data' => 'back2'], ['text' => '[🜲] 𝙊𝙬𝙣𝙚𝙧', 'url' => 'https://t.me/INS4NE_XD']]
        ]
    ]);
...
$channel = json_encode([
    'inline_keyboard' => [
        [['text' => "🌧 Owner 🌧 ", 'url' => "https://t.me/INS4NE_XD"], ['text' => "💥 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 💥", 'url' => "https://t.me/INS4NE_XD"]],
...
");
    ...
    // Change this to your video url
    $backVideoUrl = "https://t.me/okdiiecc/2"; 
    ...
    $keyboard2 = json_encode([
        'inline_keyboard' => [
                             ...
                             ['text' => '[🜲] 𝙊𝙬𝙣𝙚𝙧 ', 'url' => 'https://t.me/ins4ne_xd'],
                             ['text' => ' 𝗟𝗮𝗳𝗮 (𝗚𝗨𝗜𝗔)', 'url' => 'https://t.me/ins4ne_xd']
                                              ],
                                       ]
                                                ]);
